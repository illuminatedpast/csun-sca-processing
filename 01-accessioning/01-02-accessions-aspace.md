...
| Deaccessions | These fields are only used when a Separation is done during accessioning. For instructions on how to use these fields, see the "Weeding, Discards, and Separations" section on the [Processing page](../02-processing/02-04-physical-processing.md). |
