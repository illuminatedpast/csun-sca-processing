...
| Optional | General | This field should only be used in instances where needed information cannot be included in any other field, which happens very rarely. Consult with at least two other archivists before using this field. [See SC/A Processing Manual](../) for examples of when to consider using this field.  | 
